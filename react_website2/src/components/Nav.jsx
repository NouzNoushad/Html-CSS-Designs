                ...
                <div className="max-w-[1150px] mx-auto xl:px-0 px-5 py-3 text-[0.9rem]">
                    <div className="flex flex-row items-center justify-between">
                        <ul className='flex flex-row items-center'>
                            <li className='border-r border-gray-300 pr-6'><i class="fa fa-envelope mr-1"></i> hello@colorlib.com</li>
                            <li className='pl-6'>Free Shipping for all Order of $99</li>
                        </ul>
                        <div className="flex flex-row items-center gap-[20px]">
                            <div class="flex flex-row items-center gap-[20px] border-r border-gray-300 pr-6">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
                                <a href="#"><i class="fa fa-linkedin"></i></a>
                                <a href="#"><i class="fa fa-pinterest-p"></i></a>
                            </div>
                            <div class="flex flex-row items-center border-r border-gray-300 pr-6">
                ...
                <div className="max-w-[1150px] mx-auto xl:px-0 px-5 py-3 text-[0.9rem]">
                    <div className="flex flex-col lg:flex-row items-center justify-between w-full">
                        ...
                        <div class="lg:mt-0 mt-[1.5rem] flex flex-row items-center gap-[30px]">
                            ...
                            <div className="text-[#7d7d7d]">item: <span className='font-[700] text-black'>$150.00</span></div>
                        </div>
                    </div>
                </div>
            </div>
